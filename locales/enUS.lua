...
L["SoundControl_SoundDesc"]			= "Settings for SFX playback"
L["SoundControl_SoundEnable"]		= "Enable SFX control"
L["SoundControl_SoundMount"]		= "SFX enabled when mounted"
L["SoundControl_SoundNoMount"]		= "SFX enabled when not mounted"
